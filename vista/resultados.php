...
<html>
  ...
  <body>
    ...
    <div class="row-fluid">
      ...
      <div class="col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading text-center">Criterios para el otorgamiento del testimonio de desempeño en el test de contratación</div>
          <div class="panel-body">
            <table class="table table-hover ">
              <tbody>
                <tr>
    ...
    <div class="row-fluid">
      <div class="col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading text-center">Desempeño en cada área del test de contratación</div>
          <div class="panel-body">
      ...
      <div class="col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading text-center">Criterios para determinar los niveles de desempeño</div>
          <div class="panel-body">
            <table class="table table-hover ">
              <tbody>
                <tr>
